...
func Load() Config {
	return Config{
		...
		FabricMSPID:          getEnv("FABRIC_MSP_ID", "Org2MSP"),
		FabricCertPath:       getEnv("FABRIC_CERT_PATH", "fabric-certs/org2/signcerts/cert.pem"),
		FabricKeyPath:        getEnv("FABRIC_KEY_PATH", "fabric-certs/org2/keystore/key.pem"),
		FabricPeerHost:       getEnv("FABRIC_PEER_HOST", "peer0.org2.example.com"),
		FabricPeerEndpoint:   getEnv("FABRIC_PEER_ENDPOINT", "192.168.220.129:9051"),
		FabricTLSCertPath:    getEnv("FABRIC_TLS_CERT_PATH", "fabric-certs/org2/tls/ca.crt"),
