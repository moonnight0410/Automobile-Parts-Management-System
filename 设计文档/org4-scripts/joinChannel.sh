...
# 此脚本设计为由 addOrg4.sh 运行，作为
# 向通道添加组织教程的第二步。
# 它将 org4 peers 加入到之前在
# 测试网络教程中设置的通道。
...
# 原因是我们在这里使用 var 是考虑到 org4 特定文件夹
# 当为 org4 调用此脚本时作为 test-network/scripts/org4-scripts
